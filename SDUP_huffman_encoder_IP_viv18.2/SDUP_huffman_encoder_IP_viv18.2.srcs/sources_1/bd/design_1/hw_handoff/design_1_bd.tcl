...
proc create_root_design { parentCell } {
  ...
  # Create instance: huffman_myip_0, and set properties
  set huffman_myip_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:huffman_myip:1.0 huffman_myip_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins huffman_myip_0/S00_AXIS]
  ...
  connect_bd_intf_net -intf_net huffman_myip_0_M00_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins huffman_myip_0/M00_AXIS]
