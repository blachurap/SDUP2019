...
HD_PWD='C:/SDUP_huffman_encoder_IP_viv18.2/SDUP_huffman_encoder_IP_viv18.2.runs/design_1_huffman_myip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_huffman_myip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_huffman_myip_0_0.tcl
